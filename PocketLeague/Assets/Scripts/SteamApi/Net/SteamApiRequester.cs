...
namespace SteamApi.Net {
	public class SteamApiRequester : MonoBehaviour {
		...
		public void ResolveVanityURL(string id, Action<string> onSuccess, Action<string> onFail) {
			var baseQuery = "http://api.steampowered.com/ISteamUser/ResolveVanityURL/v0001/?key=";
			var vanityUrlQuery = "&vanityurl=";

			var url = baseQuery + _clientId.ToString() + vanityUrlQuery + id;
